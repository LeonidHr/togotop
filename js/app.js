    ...
    (() => {
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            ...
            function addOpenSpollerClass() {
                if (document.querySelector("._spoller-active")) document.documentElement.classList.add("_open-spoller"); else document.documentElement.classList.remove("_open-spoller");
            }
            startDigits();
