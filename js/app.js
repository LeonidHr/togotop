(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".counter__slider")) new core(".counter__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".possibilities__slider")) new core(".possibilities__slider", {
            ...
            if (document.querySelector(".steeps__slider")) new core(".steeps__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 16,
            ...
            if (document.querySelector(".for-whom__slider")) new core(".for-whom__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".content-reviews__slider")) new core(".content-reviews__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".rates-tabs__slider")) new core(".rates-tabs__slider", {
                ...
                pagination: {
                    el: ".rates-tabs__paginttion",
                    clickable: true
                },
                navigation: {
                    prevEl: ".rates-tabs__slider .swiper-button-prev",
            ...
            function main(postsData) {
                ...
                function displayPagination(arrData, pagesLength, page) {
                    ...
                    if (arrData.length > 6) {
                        ...
                        if (pagesLength <= 4) for (let i = 0; i < pagesLength; i++) {
                ...
                document.querySelector(paginationWrapSelector).parentElement.addEventListener("click", (e => {
                    if (e.target.closest(btnClass)) addActive(e);
        ...
        const files_pagination = pagination;
        ...
        if (document.querySelector(".aside-blog__input")) search({
            ...
            url: "./json/blog.json",
            filterContainerClass: ".tags-blog__btns",
            resultContainerClass: "#results",
            filterBtnClass: ".tags-blog__btn",
            paginationWrapSelector: "#btnWrapper",
            paginationBtnSelector: ".pagination-blog__dot"
        });
        async function search({url, inputClass, filterBtnClass, resultContainerClass, filterContainerClass, paginationWrapSelector, paginationBtnSelector}) {
            const input = document.querySelector(inputClass), filterContainer = document.querySelector(filterContainerClass);
            const data = await getData(url);
            let postsData = data.blogItems;
            let filter = "all";
            let term = "";
            files_pagination({
                posts: 6,
                postsContainerClass: resultContainerClass,
                paginationWrapSelector,
                btnClass: paginationBtnSelector,
                data: postsData
            });
            function searchItems(items, term) {
                if (0 === term.length) return items;
                return items.filter((item => item.title.indexOf(term) > -1));
            }
            function filterItems(items, filter) {
                if ("all" === filter) return items; else return items.filter((item => {
                    if (item.filter == filter) return item;
                }));
            }
            input.addEventListener("input", (e => {
                ...
                files_pagination({
                    ...
                    paginationWrapSelector,
                    btnClass: paginationBtnSelector,
                    data: filterItems(searchItems(postsData, term), filter)
                });
            }));
            filterContainer.addEventListener("click", (e => {
                if (e.target.closest(filterBtnClass)) {
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            function addHoverToMenu() {
                if (isMobile.any()) document.addEventListener("click", (e => {
                    ...
                    if (window.innerWidth >= 992) {
                        ...
                        if (!target.closest(".item-menu-spoller")) document.querySelectorAll(".item-menu-spoller").forEach((spoller => {
                            spoller.classList.remove("_hover");
                        }));
                    } else addOpenSpollerClass();
                }));
            }
            addHoverToMenu();
            function addOpenSpollerClass() {
                const header = document.querySelector("header");
                if (header.querySelector("._spoller-active")) document.documentElement.classList.add("_open-spoller"); else document.documentElement.classList.remove("_open-spoller");
            }
            startDigits();
            ...
            function startDigits() {
                ...
                digits.forEach((dig => {
                    if (dig.classList.contains("_watcher-view")) setTimeout((function() {
                        dig.innerHTML = dig.dataset.odometer;
                    }), 100); else if (dig.getBoundingClientRect().top > window.scrollY) setTimeout((function() {
                        dig.innerHTML = dig.dataset.odometer;
                    }), 100); else dig.innerHTML = "";
                }));
            }
            ...
            function changeMenuItems() {
                const menuItems = document.querySelectorAll("[data-menu-link]");
                menuItems.forEach((item => {
                    item.addEventListener("click", changeMenuItems);
                    if (document.querySelector(`#${item.dataset.go}`)) {
                        if (item.dataset.go) addDataForMenuItem(item);
                    } else if (item.dataset.go) addAnchorForMenuItem(item);
                }));
            }
